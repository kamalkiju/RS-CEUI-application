...
export default function RsauiKmtEscalate() {
  ...
  if (!sub) {
    return (
      <Layout>
        <div className="bufm-rsa-page"><p>Not found.</p><button type="button" className="btn btn-outline" onClick={() => navigate('/rsaui/kmt/document-review/review')}>Back</button></div>
      </Layout>
    )
  }
    ...
    return (
      <Layout>
        <div className="bufm-rsa-page">
          ...
          <button type="button" className="btn btn-outline" onClick={() => navigate('/rsaui/kmt/document-review/review')}>Back</button>
        </div>
      </Layout>
    )
  }
