  ...
  const filtered = useMemo(() => {
    const list =
      tab === 'draft'
        ...
        : templates.filter(t => t.status === 'submitted')
      ...
      <div className="kmt-page kmt-templates">
        <div className="kmt-templates__head">
          <div>
            ...
            <p className="kmt-page__sub">Create templates with workflow and form builder. Drafts and submitted templates.</p>
          </div>
          <button type="button" className="btn btn-primary" onClick={() => navigate('/kmt/documents/new')}>
                ...
                {filtered.map(t => (
                  <tr key={t.id}>
                    ...
                    <td className="kmt-templates-table__actions">
                      <button type="button" className="btn btn-outline kmt-btn-compact" onClick={() => navigate(`/kmt/documents/${t.id}`)}>
                        View
                      </button>
                      <button type="button" className="btn btn-primary kmt-btn-compact" onClick={() => navigate(`/kmt/documents/${t.id}/edit`)}>
                        Edit
                      </button>
                      <button
                        type="button"
